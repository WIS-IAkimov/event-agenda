export class Event {
  ...
  public _fromJson(data: any): void {
    ...
    this.startedAt = data.hasOwnProperty('start_date_timestamp') ? new Date(data['start_date_timestamp']) : this.startedAt;
    this.endedAt = data.hasOwnProperty('end_date_timestamp') ? new Date(data['end_date_timestamp']) : this.endedAt;
